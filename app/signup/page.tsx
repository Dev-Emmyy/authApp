...
export default function SignupPage() {
  ...
  return (
    ...
    >
      {/* Background Image */}
      <Image
        src="/trading-bg.jpg" // Same as login, replace if needed
      ...
      >
        ...
        <Box component="form" onSubmit={handleSubmit}>
          <TextField
            ...
            helperText={name.length < 2 && name.length > 0 ? "Minimum 2 characters" : ""}
          ...
          <TextField
            ...
            helperText={password.length < 6 && password.length > 0 ? "Minimum 6 characters" : ""}
